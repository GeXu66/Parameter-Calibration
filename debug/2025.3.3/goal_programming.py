...
# best params:  tensor([0.7106, 0.0399, 0.3087, 0.5502, 0.3223, 0.6938, 0.5973, 0.9603, 0.1740,
#         0.0064, 0.9649, 0.1803, 0.2190, 0.4054, 0.6748, 0.5179, 0.6877, 0.1066,
#         0.7877, 0.1153, 0.8332, 0.8162, 0.8856, 0.3548, 0.4320, 0.1225],
#        device='cuda:0', dtype=torch.float64)
#  best rmse:  [0.02850016728071343, 0.02944846810561032, 0.029541165375564955, 0.02949354733398735]


# best params:  tensor([0.6453, 0.1675, 0.1580, 0.5879, 0.3716, 0.5464, 0.7018, 0.8035, 0.2089,
#         0.0071, 0.8819, 0.0770, 0.4027, 0.5622, 0.7188, 0.6536, 0.7133, 0.1023,
#         0.8273, 0.1904, 0.7527, 0.5842, 0.8721, 0.4143, 0.3843, 0.1333],
#        device='cuda:0', dtype=torch.float64)
#  best rmse:  [0.02966867294756724, 0.028939237986079166, 0.031873921242777166, 0.029795827813172783]
...
def optimize_battery_params():
    ...
    with open(r'\\wsl.localhost\Ubuntu\mnt\e\Battery_research\Parameter Calibration\feasible_solutions.csv', 'w', newline='') as csvfile:
        writer = csv.writer(csvfile)
        writer.writerow(['Solution', 'RMSE'])
        for solution, rmse in zip(feasible_solutions, feasible_rmse):
            writer.writerow([solution, rmse])
