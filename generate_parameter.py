...
model_list = ["Ai2020", "Chen2020", "Ecker2015", "Marquis2019", "Mohtat2020", "NCA_Kim2011", "ORegan2021", "Prada2013", "Ramadass2004", "Xu2019"]
...
#     if write:
#         # 写入变量到CSV文件
#         with open(f'./DFN_parameter_sets/{model_name}_variables.csv', 'w', newline='') as file:
...
#
#         # 写入参数到CSV文件
#         with open(f'./DFN_parameter_sets/{model_name}_parameters.csv', 'w', newline='') as file:
#             writer = csv.writer(file)
