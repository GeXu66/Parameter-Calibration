%% Script description
% Script used to obtain impedance datas shown in Figures 10 and 14(a and b).
...
Ds_neg_0 = p.Ds_neg_0 * Multiple;   % settings for parametric studies
for m = 1:length(Multiple)
    p.Ds_neg_0 = Ds_neg_0(m);       % settings for parametric studies
