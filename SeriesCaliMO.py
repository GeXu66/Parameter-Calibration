...
def pybamm_sim(param, min_voltage, max_voltage, discharge_cur, time_max, capacity, temperature):
    electrode_height = min_max_func(0.01, 1, param[0])
    electrode_width = min_max_func(0.01, 2, param[1])
    Negative_electrode_conductivity = min_max_func(0, 215, param[2])
    Positive_electrode_diffusivity = min_max_func(5.9e-18, 1e-14, param[3])
    Positive_particle_radius = min_max_func(1e-10, 1e-5, param[4])
    ...
    Negative_particle_radius = min_max_func(0.0000001083, 0.0000137, param[8])
    Negative_electrode_thickness = min_max_func(0.000016, 0.0007, param[9])
    Total_heat_transfer_coefficient = min_max_func(1, 35, param[10])
    Separator_density = min_max_func(397, 2470, param[11])
    Separator_thermal_conductivity = min_max_func(0.10672, 0.34, param[12])
    Positive_electrode_porosity = min_max_func(0.01728395, 0.4, param[13])
    ...
    Negative_electrode_Bruggeman_coefficient = min_max_func(0.1, 4, param[16])
    Positive_electrode_Bruggeman_coefficient = min_max_func(0.5, 4, param[17])
    Separator_porosity = min_max_func(0.19, 1, param[18])
    Negative_current_collector_thickness = min_max_func(0.000001, 0.000025, param[19])
    Positive_current_collector_thickness = min_max_func(0.000001, 0.000025, param[20])
    Positive_electrode_thickness = min_max_func(0.000042, 0.0001, param[21])
    Positive_electrode_active_material_volume_fraction = min_max_func(0.18485556, 0.665, param[22])
    Negative_electrode_specific_heat_capacity = min_max_func(300, 1437, param[23])
    Positive_electrode_thermal_conductivity = min_max_func(0.5, 2.1, param[24])
    Negative_electrode_active_material_volume_fraction = min_max_func(0.172403, 0.75, param[25])
    Negative_electrode_density = min_max_func(1000, 3100, param[26])
    Positive_electrode_specific_heat_capacity = min_max_func(700, 1270, param[27])
    Positive_electrode_density = min_max_func(1500, 4206, param[28])
    Negative_electrode_thermal_conductivity = min_max_func(0.5, 1.7, param[29])
    Cation_transference_number = min_max_func(0.15, 0.4, param[30])
    ...
    Maximum_concentration_in_negative_electrode = min_max_func(20000, 33133, param[34])
    Positive_current_collector_density = min_max_func(2700, 3490, param[35])
    Negative_current_collector_density = min_max_func(4000, 11544, param[36])
    ...
    min_voltage = min_max_func(min_voltage - 2, min_voltage + 0.5, param[40])
    max_voltage = min_max_func(max_voltage - 0.8, max_voltage + 1.5, param[41])
...
if __name__ == '__main__':
    ...
    name = args.filename
    file_name = name.split(",")[0].split("-")[0] + "MOS"
